...
zip -j public/rosen_components.zip public/rosen-chain-performance.html public/rosen-permits.html  public/rosen-statistics.html public/rosen-performance.html public/rosen-watchers.html public/rosen*.js public/styles*.css
