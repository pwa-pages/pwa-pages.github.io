...
export class ServiceWorkerService {
    ...
    this.http
      ...
      .subscribe(
        (data) => {
          ...
          console.log(
            'localStorage antichessServiceVersion:',
            localStorage.getItem('antichessServiceVersion'),
          );
  ...
  getVersion(): string | null {
    const version = localStorage.getItem('antichessServiceVersion');
    return version;
  }
    ...
    if (navigator.serviceWorker) {
      ...
      navigator.serviceWorker.addEventListener('message', (event) => {
        ...
        if (v) {
          ...
          localStorage.setItem('antichessServiceVersion', v);
        }
      });
    } else {
