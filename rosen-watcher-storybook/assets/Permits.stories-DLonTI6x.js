...
<hr />
`,r={address1:"9fTbZHMsuBeWYAWsw7Nr61zNSe4i2FLrREhJcFGRkKLmNYVFwqL",address2:"9ffqtz3Nck92gWJf6FLbyDcqXattsTyxWzsSn7erkZfNY9DMNvN",address3:"9gFFEZPoDUAA1jgfoNMN5FMARPUbuRHGB8sS8i6Lm1M9dXAiVx9",address4:"9gJM9rnPkHpX7fou7PXZH76utZirdAnCEh8d3YZ4vcXi9pNHfqz"};var p=l.replace(/__SCRIPT_FILE__/g,i).replace(/__STYLE_FILE__/g,c);const y={title:"Components/Permits",tags:["autodocs"],render:e=>h({...e}),argTypes:{address1:{control:"text"},address2:{control:"text"},address3:{control:"text"},address4:{control:"text"}},args:r,parameters:{docs:{page:()=>o.createElement("div",{dangerouslySetInnerHTML:{__html:p}})}}};function m(e){return`
  ...
  `}const n={args:{address1:"9fTbZHMsuBeWYAWsw7Nr61zNSe4i2FLrREhJcFGRkKLmNYVFwqL",address2:"9ffqtz3Nck92gWJf6FLbyDcqXattsTyxWzsSn7erkZfNY9DMNvN",address3:"9gFFEZPoDUAA1jgfoNMN5FMARPUbuRHGB8sS8i6Lm1M9dXAiVx9",address4:"9gJM9rnPkHpX7fou7PXZH76utZirdAnCEh8d3YZ4vcXi9pNHfqz"},name:"Explore Component",parameters:{docs:{source:{code:m(r)}}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...n.parameters?.docs?.source}}};const w=["Primary"];export{n as Primary,w as __namedExportsOrder,y as default};
