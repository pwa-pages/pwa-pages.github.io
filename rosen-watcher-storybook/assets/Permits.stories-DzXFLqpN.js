/* empty css              */import{e as o}from"./index-1v6kQ9Nt.js";import{r as i,a as c}from"./iframe-G2uII39B.js";import"./preload-helper-D9Z9MdNV.js";const h=({address1:e,address2:d,address3:s,address4:a})=>{const t=document.createElement("rosen-watcher-component");return t.setAttribute("component","permits"),t.setAttribute("render-html","true"),t.setAttribute("address1",e),t.setAttribute("address2",d),t.setAttribute("address3",s),t.setAttribute("address4",a),t},l=`<h3>Description</h3>
...
<hr />
`,r={address1:"9f6pDdMhgYrHoCcQmGVuSzSx7nWaRwVPKASvEeKUeWTmvTVRZ38",address2:"9gnew46Ts9wZQWmbMWTebJE1yhqc1FAMXt3qQa8LjW3Uu7D4KnD",address3:"9ehyh2Ti9kBvnodWsafHhzT5557eTwWsKLdvRFhipmLmWAqYhAv",address4:"9htrN7JGgi8bxABJLCCskWqAHpatQqttFUF6GY68yaEbahG5Vx6"};var p=l.replace(/__SCRIPT_FILE__/g,i).replace(/__STYLE_FILE__/g,c);const y={title:"Components/Permits",tags:["autodocs"],render:e=>h({...e}),argTypes:{address1:{control:"text"},address2:{control:"text"},address3:{control:"text"},address4:{control:"text"}},args:r,parameters:{docs:{page:()=>o.createElement("div",{dangerouslySetInnerHTML:{__html:p}})}}};function m(e){return`
  ...
  `}const n={args:{address1:"9f6pDdMhgYrHoCcQmGVuSzSx7nWaRwVPKASvEeKUeWTmvTVRZ38",address2:"9gnew46Ts9wZQWmbMWTebJE1yhqc1FAMXt3qQa8LjW3Uu7D4KnD",address3:"9ehyh2Ti9kBvnodWsafHhzT5557eTwWsKLdvRFhipmLmWAqYhAv",address4:"9htrN7JGgi8bxABJLCCskWqAHpatQqttFUF6GY68yaEbahG5Vx6"},name:"Explore Component",parameters:{docs:{source:{code:m(r)}}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...n.parameters?.docs?.source}}};const T=["Primary"];export{n as Primary,T as __namedExportsOrder,y as default};
