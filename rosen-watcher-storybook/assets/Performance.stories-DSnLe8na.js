import{e as h}from"./index-1v6kQ9Nt.js";import{r as l,a as p}from"./iframe-B8Mnpr1S.js";import"./preload-helper-D9Z9MdNV.js";const r=({backgroundColor:e,accentChartColor:a,address1:d,address2:s,address3:c,address4:i})=>{const t=document.createElement("rosen-watcher-component");return t.setAttribute("component","performance"),t.setAttribute("render-html","true"),t.setAttribute("address1",d),t.setAttribute("address2",s),t.setAttribute("address3",c),t.setAttribute("address4",i),t.setAttribute("accent-chart-color",a),t.setAttribute("style","border:1px solid black; width: 500px; height:300px; display: block;"),t.style.backgroundColor=e,t},m=`<h3>Description</h3>
...
&lt;html&gt;
  &lt;head&gt;
    &lt;link rel="stylesheet" href="__STYLE_FILE__" media="all" onload="this.media='all'" /&gt;
...
<table>
...
</table>`,o={address1:"9fTbZHMsuBeWYAWsw7Nr61zNSe4i2FLrREhJcFGRkKLmNYVFwqL",address2:"9ffqtz3Nck92gWJf6FLbyDcqXattsTyxWzsSn7erkZfNY9DMNvN",address3:"9gFFEZPoDUAA1jgfoNMN5FMARPUbuRHGB8sS8i6Lm1M9dXAiVx9",address4:"9gJM9rnPkHpX7fou7PXZH76utZirdAnCEh8d3YZ4vcXi9pNHfqz",accentChartColor:"#666666"};var f=m.replace(/__SCRIPT_FILE__/g,l).replace(/__STYLE_FILE__/g,p);const w={title:"Components/Performance",tags:["autodocs"],render:e=>r({...e}),argTypes:{backgroundColor:{control:"color"},accentChartColor:{control:"color"},address1:{control:"text"},address2:{control:"text"},address3:{control:"text"},address4:{control:"text"}},args:o,parameters:{docs:{page:()=>h.createElement("div",{dangerouslySetInnerHTML:{__html:f}})}}};function u(e){return`
  ...
  `}const n={name:"Explore Component",args:{address1:"9fTbZHMsuBeWYAWsw7Nr61zNSe4i2FLrREhJcFGRkKLmNYVFwqL",address2:"9ffqtz3Nck92gWJf6FLbyDcqXattsTyxWzsSn7erkZfNY9DMNvN",address3:"9gFFEZPoDUAA1jgfoNMN5FMARPUbuRHGB8sS8i6Lm1M9dXAiVx9",address4:"9gJM9rnPkHpX7fou7PXZH76utZirdAnCEh8d3YZ4vcXi9pNHfqz"},parameters:{docs:{source:{code:u(o)}}},render:e=>r({...e})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  name: 'Explore Component',
  args: {
    address1: '9fTbZHMsuBeWYAWsw7Nr61zNSe4i2FLrREhJcFGRkKLmNYVFwqL',
    address2: '9ffqtz3Nck92gWJf6FLbyDcqXattsTyxWzsSn7erkZfNY9DMNvN',
    address3: '9gFFEZPoDUAA1jgfoNMN5FMARPUbuRHGB8sS8i6Lm1M9dXAiVx9',
    address4: '9gJM9rnPkHpX7fou7PXZH76utZirdAnCEh8d3YZ4vcXi9pNHfqz'
  },
  parameters: {
    docs: {
      source: {
...
}`,...n.parameters?.docs?.source}}};const T=["Primary"];export{n as Primary,T as __namedExportsOrder,w as default};
