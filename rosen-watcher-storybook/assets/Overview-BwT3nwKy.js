...
If only events are needed, the components can be used without HTML.`})}),e.jsx("li",{children:e.jsx(n.p,{children:`Changes to the properties of the components will automatically be picked up,
