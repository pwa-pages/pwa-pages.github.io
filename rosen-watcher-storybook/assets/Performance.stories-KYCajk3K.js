...
This component gives insight in how different addresses perform compared to each other per week.
<br/>
...
similar as to how it is shown in the html part of this component.
</p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>string</td>
      <td>Color used for chart representation if one needs.</td>
    </tr>
  </tbody>
</table>`,o={address1:"9f6pDdMhgYrHoCcQmGVuSzSx7nWaRwVPKASvEeKUeWTmvTVRZ38",address2:"9gnew46Ts9wZQWmbMWTebJE1yhqc1FAMXt3qQa8LjW3Uu7D4KnD",address3:"9ehyh2Ti9kBvnodWsafHhzT5557eTwWsKLdvRFhipmLmWAqYhAv",address4:"9htrN7JGgi8bxABJLCCskWqAHpatQqttFUF6GY68yaEbahG5Vx6",accentChartColor:"#666666"};var u=m.replace(/__SCRIPT_FILE__/g,l).replace(/__STYLE_FILE__/g,p);const w={title:"Components/Performance",tags:["autodocs"],render:e=>r({...e}),argTypes:{backgroundColor:{control:"color"},accentChartColor:{control:"color"},address1:{control:"text"},address2:{control:"text"},address3:{control:"text"},address4:{control:"text"}},args:o,parameters:{docs:{page:()=>i.createElement("div",{dangerouslySetInnerHTML:{__html:u}})}}};function g(e){return`
