...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item" >QueryParamNameDirective</li>
</ol>
...
<div class="tab-content">
    <div class="tab-pane fade active in" id="info">
        ...
        <p class="comment">
            <code>test/fixtures/sample-files/query-param-name.directive.ts</code>
        </p>
            ...
            <p class="comment">
                <p>Binds a <a href="QueryParam">QueryParam</a> to a DOM element.</p>
<p>This directive accepts the name of a <a href="QueryParam">QueryParam</a> inside its parent <a href="QueryParamGroup">QueryParamGroup</a>.
It binds this parameter to the host element, which is required to have a [ControlValueAccessor]
<a href="https://angular.io/api/forms/ControlValueAccessor">https://angular.io/api/forms/ControlValueAccessor</a>.</p>
        ...
        <section data-compodoc="block-metadata">
            ...
            <table class="table table-sm table-hover metadata">
                <tbody>
                    ...
                    <tr>
                        <td class="col-md-3">Sélecteur</td>
                        <td class="col-md-9"><code>[queryParamName]</code></td>
                    </tr>
        ...
        <tbody>
                    ...
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                ...
                                <a href="#valueAccessor" >valueAccessor</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                <a href="#queryParamName" >queryParamName</a>
                            </li>
                        </ul>
                    </td>
                </tr>
    ...
    <h3 id="constructor">Constructeur</h3>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
<code>constructor(groupService: <a href="../injectables/QueryParamGroupService.html" target="_self">QueryParamGroupService</a>, valueAccessors: ControlValueAccessor[])</code>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Défini dans <a href="" data-line="35" class="link-to-prism">test/fixtures/sample-files/query-param-name.directive.ts:35</a></div>
                            </td>
                        </tr>
                                    ...
                                    <table class="params">
                                        ...
                                        <tbody>
                                                <tr>
                                                        ...
                                                        <td>
                                                                        <code><a href="../injectables/QueryParamGroupService.html" target="_self" >QueryParamGroupService</a></code>
                                                        </td>
                    ...
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Défini dans <a href="" data-line="32" class="link-to-prism">test/fixtures/sample-files/query-param-name.directive.ts:32</a></div>
                            </td>
                        </tr>
                <tr>
                    <td class="col-md-4">
                        <div class="io-description"><p>The name of the <a href="QueryParam">QueryParam</a> inside its parent <a href="QueryParamGroup">QueryParamGroup</a>.
Note that this does not refer to the <a href="QueryParam#urlParam">parameter name</a>.</p>
</div>
                    </td>
                </tr>
            </tbody>
    ...
    <table class="table table-sm table-bordered">
        <tbody>
            <tr>
                <td class="col-md-4">
                    <a name="valueAccessor"></a>
                    <span class="name">
                            <span class="modifier">Public</span>
                        <span ><b>valueAccessor</b></span>
                        <a href="#valueAccessor"><span class="icon ion-ios-link"></span></a>
                    </span>
                </td>
            </tr>
                <tr>
                    <td class="col-md-4">
                        <i>Type : </i>    <code>ControlValueAccessor | null</code>

                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <i>Valeur par défaut : </i><code>null</code>
                    </td>
                </tr>
                    <tr>
                        <td class="col-md-4">
...
export class QueryParamNameDirective implements QueryParamAccessor, OnChanges, OnDestroy {
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'QueryParamNameDirective.html';
