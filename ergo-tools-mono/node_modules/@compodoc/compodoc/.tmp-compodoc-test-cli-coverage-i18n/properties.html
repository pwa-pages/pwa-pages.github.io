...
<html class="no-js" lang="">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">Propriétés</li>
    </ol>
    <ul class="properties-list">
        <li>
            <b>Version</b> : 1.1.31</li>
        <li>
            <b>Description</b> : The missing documentation tool for your Angular application</li>
        <li>
            <b>Keywords</b> : angular2, angular, documentation, components, module, graph, dependencies, markdown</li>
        <li>
            <b>Homepage</b> : https://github.com/compodoc/compodoc#readme</li>
        <li>
            <b>Bugs</b> : https://github.com/compodoc/compodoc/issues</li>
        <li>
            <b>License</b> : MIT</li>
        <li>
            <b>Repository</b> : git+https://github.com/compodoc/compodoc.git</li>
        <li>
            <b>Author</b> : Vindent Ogloblinsky (vincent.ogloblinsky@gmail.com)</li>
    </ul>
