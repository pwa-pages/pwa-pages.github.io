...
`),o},{expect:s,userEvent:m,within:h}=__STORYBOOK_MODULE_TEST__,b={title:"Example/Page",render:()=>u(),parameters:{layout:"fullscreen"}},a={},r={play:async({canvasElement:o})=>{const e=h(o),t=e.getByRole("button",{name:/Log in/i});await s(t).toBeInTheDocument(),await m.click(t),await s(t).not.toBeInTheDocument();const n=e.getByRole("button",{name:/Log out/i});await s(n).toBeInTheDocument()}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"{}",...a.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
