...
- fix(app): i18next default namespace and init ([b7a5865](https://github.com/compodoc/compodoc/commit/b7a5865)), closes [#1643](https://github.com/compodoc/compodoc/issues/1643) [#1645](https://github.com/compodoc/compodoc/issues/1645)
...
Huge thanks to [tcorral](https://github.com/tcorral) for the great work in this release ! 👏

### Merged

- Migration/express to polka [#1623](https://github.com/compodoc/compodoc/pull/1623)
- fix: enhance JSON5 parsing error handling in RouterParserUtil [#1611](https://github.com/compodoc/compodoc/pull/1611)
- refactor: update CLI options to use COMPODOC_DEFAULTS for default values [#1607](https://github.com/compodoc/compodoc/pull/1607)
- fix: using disableOverview the outcome was broken. [#1609](https://github.com/compodoc/compodoc/pull/1609)
- feat: add Template Playground [#1587](https://github.com/compodoc/compodoc/pull/1587)
- feat: Add a new disableFilePath flag [#1585](https://github.com/compodoc/compodoc/pull/1585)
- fix: JSDoc @example parsing issue [#1584](https://github.com/compodoc/compodoc/pull/1584)
- feat: Add disableOverview flag [#1586](https://github.com/compodoc/compodoc/pull/1586)
- fix(app): fix logger padding issue [#1582](https://github.com/compodoc/compodoc/pull/1582)
- fix(app): fix unit tests broken by signal inputs [#1577](https://github.com/compodoc/compodoc/pull/1577)
- fix: unit test for input output signal [#1578](https://github.com/compodoc/compodoc/pull/1578)
- fix: input and output signals are listed in properties [#1549](https://github.com/compodoc/compodoc/pull/1549)
- fix(app): typo in directive outputs [#1548](https://github.com/compodoc/compodoc/pull/1548)
- feat(app): better handle multiple types, default values, and options for input/output/model signals [#1526](https://github.com/compodoc/compodoc/pull/1526)
- fix(symbolHelper): properly parse provider config object [#1524](https://github.com/compodoc/compodoc/pull/1524)

### Bug fixes

- fix(app): relaxed regex for input signals detection ([d8cb344](https://github.com/compodoc/compodoc/commit/d8cb344)), closes [#1494](https://github.com/compodoc/compodoc/issues/1494)
- fix(coverage): Incorrect URL creation for Entity files ([58e6208](https://github.com/compodoc/compodoc/commit/58e6208)), closes [#1531](https://github.com/compodoc/compodoc/issues/1531)

### Commits

- Add Template Playground [7b38c4a](https://github.com/compodoc/compodoc/commit/7b38c4ae0c9da51fcb64a825a3cef7eea865737d)
- feat(deps): update dependencies and enhance template playground server [2264305](https://github.com/compodoc/compodoc/commit/2264305be729d346c3edb2534682dd7397d71960)
- refactor: clean up utility functions and remove unused test files [2ea32c9](https://github.com/compodoc/compodoc/commit/2ea32c94c48949fd8bc83c8ad20c3681235dad69)
