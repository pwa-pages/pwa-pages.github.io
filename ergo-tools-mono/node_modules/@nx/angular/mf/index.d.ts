 ...
 */
declare function setRemoteUrlResolver(_resolveRemoteUrl: ResolveRemoteUrlFunction): void;
/**
 ...
 * ```
 */
declare function setRemoteDefinitions(definitions: Record<string, string>): void;
/**
 ...
 * ```
 */
declare function setRemoteDefinition(remoteName: string, remoteUrl: string): void;
/**
