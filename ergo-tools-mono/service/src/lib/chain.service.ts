...
const chainTypeTokens = Object.fromEntries(
  Object.values(ChainType).map((chain) =>
    chain === ChainType.Runes ? [chain, `rspv2BitcoinRunesRWT`] :
...
const rwtTokenIds: Record<string, ChainType> = {
  '8a94d71b4a08058327fa8372aa69d95c337536c6577c31c8d994169a041e5fc0':
    ChainType.Ergo,
  ...
  '30e4392fc439fce9948da124efddb8779fe179eef5a5d6196e249b75ee64defc':
    ChainType.Bitcoin,
  f5985c64c1aa8f08569dc77a046f65f92947abaa9ccd530aead033eece23496e:
    ChainType.Ethereum,
  '33477693d6be5bbd3a4cd786fbff5e6444449c191ab08e681aaaa87fc192772c':
    ChainType.Binance,
