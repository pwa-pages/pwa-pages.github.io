...
<div class="container-fluid modules">
    <div class="row">
                ...
                <div class="card card-module">
                    ...
                    <div class="card-block">
                        ...
                        <footer class="text-center">
                            <a href="./modules/AppModule.html" class="btn btn-default">Parcourir</a>
                        </footer>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="card card-module">
                    <div class="card-header">
                        <h4 class="card-title">BarModule</h4>
                    </div>
                    <div class="card-block">
                                <p>
                                    <object id="demo-svg" type="image/svg+xml" lazy="./modules/BarModule/dependencies.svg" style="width: 100%; height: 175px;">
                                        Votre navigateur ne supporte pas le SVG
                                    </object>
                                </p>
                        <footer class="text-center">
                            <a href="./modules/BarModule.html" class="btn btn-default">Parcourir</a>
                        </footer>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="card card-module">
                    <div class="card-header">
                        <h4 class="card-title">DeepModule</h4>
                    </div>
                    <div class="card-block">
                                <p class="no-graph">
                        ...
                        <footer class="text-center">
                            <a href="./modules/DeepModule.html" class="btn btn-default">Parcourir</a>
                        </footer>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="card card-module">
                    <div class="card-header">
                        <h4 class="card-title">EmptyModule</h4>
                    </div>
                    <div class="card-block">
                                <p class="no-graph">
                                    Aucun graphique disponible.
                        ...
                        <footer class="text-center">
                            <a href="./modules/EmptyModule.html" class="btn btn-default">Parcourir</a>
                        </footer>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="card card-module">
                    <div class="card-header">
                        <h4 class="card-title">EmptyRawModule</h4>
                    </div>
                    <div class="card-block">
                                <p class="no-graph">
                                    Aucun graphique disponible.
                        ...
                        <footer class="text-center">
                            <a href="./modules/EmptyRawModule.html" class="btn btn-default">Parcourir</a>
                        </footer>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="card card-module">
                    <div class="card-header">
                        <h4 class="card-title">FooModule</h4>
                    </div>
                    <div class="card-block">
                                <p class="no-graph">
                                    Aucun graphique disponible.
                        ...
                        <footer class="text-center">
                            <a href="./modules/FooModule.html" class="btn btn-default">Parcourir</a>
                        </footer>
                    </div>
                </div>
            </div>
