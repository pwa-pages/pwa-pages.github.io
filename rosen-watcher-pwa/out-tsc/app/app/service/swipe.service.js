...
let SwipeService = class SwipeService {
    constructor(eventService, router) {
        this.router = router;
        this.detectHorizontal = true;
        this.detectVertical = false;
        this.currentNavigationLeft = 'main';
        this.currentNavigationRight = 'main';
    ...
    hasVerticalScrollableContainerClass(element) {
        while (element) {
    ...
    swipeDetect(routeleft, routeRight) {
        this.currentNavigationLeft = routeleft;
        this.currentNavigationRight = routeRight;
    }
    registerSwipeDetect() {
        const threshold = 10, body = document.body, html = document.documentElement;
        let startX, startY, distX, distY, contentLeft, contentTop;
        ...
        body.addEventListener('touchmove', (e) => {
            ...
            const hasVerticalScrollableParent = this.hasVerticalScrollableContainerClass(e.target);
            const touchobj = e.changedTouches[0];
