/* empty css              */import{e}from"./index-1v6kQ9Nt.js";import{r,a as o}from"./iframe-BvOc4_TI.js";import"./preload-helper-D9Z9MdNV.js";const a=({})=>{const t=document.createElement("rosen-watcher-component");return t.setAttribute("component","permits"),t.setAttribute("render-html","true"),t},d=`<h3>Description</h3>
...
<hr />
`,c={};var l=d.replace(/__SCRIPT_FILE__/g,r).replace(/__STYLE_FILE__/g,o);const p={title:"Components/Permits",tags:["autodocs"],render:t=>a({...t}),argTypes:{backgroundColor:{control:"color"}},args:c,parameters:{docs:{page:()=>e.createElement("div",{dangerouslySetInnerHTML:{__html:l}})}}};function s(t){return`
  ...
  `}const n={args:{},name:"Explore Component",parameters:{docs:{source:{code:s()}}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {},
...
}`,...n.parameters?.docs?.source}}};const g=["Primary"];export{n as Primary,g as __namedExportsOrder,p as default};
