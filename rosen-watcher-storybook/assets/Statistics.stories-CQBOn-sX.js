/* empty css              */import{e as p}from"./index-1v6kQ9Nt.js";import{r as u,a as m}from"./iframe-CReibHnE.js";import"./preload-helper-D9Z9MdNV.js";const o=({period:t,backgroundColor:r,chartTitle:a,chartColor:d,accentChartColor:c,address1:i,address2:h,style:l="border:1px solid black; width: 500px; height:300px; display: block;"})=>{const e=document.createElement("rosen-watcher-component");return e.setAttribute("component","statistics"),e.setAttribute("render-html","true"),e.setAttribute("address1",i),e.setAttribute("address2",h),e.setAttribute("period",t),e.setAttribute("chart-title",a),e.setAttribute("chart-color",d),e.setAttribute("accent-chart-color",c),e.setAttribute("style",l),e.style.backgroundColor=r,e},b=`<h3>Description</h3>
...
<p>Fired whenever the statistics update after incremental downloads are done, component can send multiple events of type notifyStatisticsChartChanged
...
`,s={address1:"9f6pDdMhgYrHoCcQmGVuSzSx7nWaRwVPKASvEeKUeWTmvTVRZ38",address2:"",chartTitle:"Lobster pool rewards",chartColor:"#666666",accentChartColor:"#cccccc",period:"All"};var g=b.replace(/__SCRIPT_FILE__/g,u).replace(/__STYLE_FILE__/g,m);const x={title:"Components/Statistics",tags:["autodocs"],render:t=>o({...t}),argTypes:{backgroundColor:{control:"color"},accentChartColor:{control:"color"},chartColor:{control:"color"},address1:{control:"text"},address2:{control:"text"},period:{control:{type:"select"},options:["Day","Week","Month","Year","All"]}},args:s,parameters:{docs:{page:()=>p.createElement("div",{dangerouslySetInnerHTML:{__html:g}})}}};function y(t){return`
  ...
  `}const n={name:"Explore Component",args:{address1:"",address2:"9f6pDdMhgYrHoCcQmGVuSzSx7nWaRwVPKASvEeKUeWTmvTVRZ38"},parameters:{docs:{source:{code:y(s)}}},render:t=>o({...t,style:"display: block; width: 600px; height: 350px; border: 2px solid #666; border-radius: 8px; background: #f9f9f9; padding: 16px;"})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
...
}`,...n.parameters?.docs?.source}}};const T=["Primary"];export{n as Primary,T as __namedExportsOrder,x as default};
