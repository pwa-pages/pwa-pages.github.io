/* empty css              */import{e as c}from"./index-1v6kQ9Nt.js";import{r as s,a as l}from"./iframe-C6d2SgOv.js";import"./preload-helper-D9Z9MdNV.js";const i=({address1:t,address2:o,address3:a,address4:d})=>{const e=document.createElement("rosen-watcher-component");return e.setAttribute("component","permits"),e.setAttribute("render-html","true"),e.setAttribute("address1",t),e.setAttribute("address2",o),e.setAttribute("address3",a),e.setAttribute("address4",d),e},h=`<h3>Description</h3>
...
<hr />
`,r={address1:"9f6pDdMhgYrHoCcQmGVuSzSx7nWaRwVPKASvEeKUeWTmvTVRZ38",address2:"9gnew46Ts9wZQWmbMWTebJE1yhqc1FAMXt3qQa8LjW3Uu7D4KnD",address3:"9ehyh2Ti9kBvnodWsafHhzT5557eTwWsKLdvRFhipmLmWAqYhAv",address4:"9htrN7JGgi8bxABJLCCskWqAHpatQqttFUF6GY68yaEbahG5Vx6"};var u=h.replace(/__SCRIPT_FILE__/g,s).replace(/__STYLE_FILE__/g,l);const w={title:"Components/Permits",tags:["autodocs"],render:t=>i({...t}),argTypes:{address1:{control:"text"},address2:{control:"text"},address3:{control:"text"},address4:{control:"text"}},args:r,parameters:{docs:{page:()=>c.createElement("div",{dangerouslySetInnerHTML:{__html:u}})}}};function m(t){return`
