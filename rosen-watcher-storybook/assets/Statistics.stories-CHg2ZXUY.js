...
`,o={address1:"9ehyh2Ti9kBvnodWsafHhzT5557eTwWsKLdvRFhipmLmWAqYhAv",address2:"",chartTitle:"Lobster pool rewards",chartColor:"#666666",accentChartColor:"#cccccc",period:"All"};var g=b.replace(/__SCRIPT_FILE__/g,u).replace(/__STYLE_FILE__/g,m);const v={title:"Components/Statistics",tags:["autodocs"],render:t=>r({...t}),argTypes:{backgroundColor:{control:"color"},accentChartColor:{control:"color"},chartColor:{control:"color"},address1:{control:"text"},address2:{control:"text"},period:{control:{type:"select"},options:["Day","Week","Month","Year","All"]}},args:o,parameters:{docs:{page:()=>p.createElement("div",{dangerouslySetInnerHTML:{__html:g}})}}};function y(t){return`
  ...
  `}const n={name:"Explore Component",args:{address1:"",address2:"9ehyh2Ti9kBvnodWsafHhzT5557eTwWsKLdvRFhipmLmWAqYhAv"},parameters:{docs:{source:{code:y(o)}}},render:t=>r({...t})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
