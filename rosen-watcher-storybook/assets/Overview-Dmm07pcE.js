...
Newer versions will need to be installed when new chains enter rosen bridge,
but this will only be an inclusion of a different javascript with a newer version.
...
The components should be able to resize correctly based on the calculated css size.
